...
![](/assets/type.PNG)**ছবি: ভাড়ার গ্রূপের এগ্রিগেট**
...
![](/assets/table-famid.png)**ছবি: FamilyID'র একটা টেবিল**
...
![](/assets/sized.png)**ছবি: FamilySizeGroup'এর একটা টেবিল**
...
fancyRpartPlot\(fit\)![](/assets/Rplot23.png)**ছবি: আমাদের তৈরী Title এবং FamilyID ডিসিশন ট্রির একদম ওপরে **
...
write.csv\(submit, file = "prediction5th.csv", row.names = FALSE\)![](/assets/submit5.png)**ছবি: ৫ম ক্যাগল সাবমিশন - ৭৯.৯% অ্যাকুরেসি**
